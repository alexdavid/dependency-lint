(function() {
  ...
  RequiredModuleFinder = (function() {
    ...
    RequiredModuleFinder.prototype.normalizeModuleNames = function(arg) {
      ...
      return _.chain(moduleNames).map(ModuleNameParser.stripLoaders).reject(ModuleNameParser.isBuiltIn).reject(ModuleNameParser.isRelative).map(ModuleNameParser.stripSubpath).map(function(name) {
        return {
          name: name,
          file: filePath
        };
